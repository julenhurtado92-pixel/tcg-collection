(() => {
  ...
  function renderPrices() {
    ...
    const pending = cards.filter((card) => ['ambiguous', 'unmatched', 'insufficient_sample', 'unsupported_language', 'live_error', 'live_skipped_limit', 'scrape_blocked', 'scrape_error', 'scrape_no_product_page', 'scrape_skipped_limit', 'requested', 'not_requested'].includes(marketStatus(card))).length;
